...
class _HomeState extends State<Home> {
  Future<Map<String, dynamic>> fetchTotalDeviceData() async {
    final response = await http
        .get(Uri.parse('https://power-mag-sys.onrender.com/api/allDevices'));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: fetchTotalDeviceData,
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          text:data['Meter_Reading']!=null? "${formatter.format(data['Battery_Level'])}":"0.0",
                                          style: const TextStyle(
                                            fontSize: 30,
                                            fontWeight: FontWeight.bold,
                                            color: Color.fromRGBO(255, 255, 255, 1),
